...
const Products = () => {
  ...
  return (
    <Wrapper className='h-[5000px] overflow-y-auto px-[5px] mobile-m:px-[20px] mobile-l:[25px] laptop:px-[50px] laptop-lg:px-[108px]'>
     ...
     {/* header tags start */}
      <div>
        ...
        <div className="w-72 laptop:left-[674.5px] laptop-lg:left-[1044.5px] top-[124px] absolute bg-white border border-neutral-200 justify-start items-start hidden laptop:inline-flex">
